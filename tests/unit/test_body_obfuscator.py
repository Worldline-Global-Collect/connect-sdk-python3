...
class BodyObfuscatorTest(unittest.TestCase):
    ...
    def test_obfuscate_body_empty(self):
        """Tests if the obfuscate_body function is capable of obfuscating an empty body"""
        body = ""
    ...
    def test_obfuscate_body_card(self):
        """Tests that the obfuscate_body function correctly obfuscates a json containing payment card card data"""
    ...
    def test_obfuscate_body_card_custom_rule(self):
        """Tests that the obfuscate_body function correctly obfuscates a json containing payment card card data with a custom rule"""
    ...
    def test_obfuscate_body_iban(self):
        """Tests that the obfuscate_body function correctly obfuscates a json containing an iban number"""
    ...
    def test_obfuscate_body_object(self):
        """Tests that the obfuscate_body function correctly obfuscates a json containing an object that does not need to be obfuscated"""
    ...
    def obfuscate_body_match(self, original_resource, obfuscated_resource, body_obfuscator=BodyObfuscator.default_body_obfuscator()):
        """Tests that the obfuscate_body function obfuscates the json in original_resource to the json in obfuscated_resource
    ...
    def obfuscate_body_no_match(self, resource):
        """Tests that the obfuscate_body function does not obfuscate the json given in the resource file
