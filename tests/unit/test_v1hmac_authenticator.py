...
class V1HMACAuthenticatorTest(unittest.TestCase):
    ...
    def test_canonicalized_header_value(self):
        ...
        """
        self.assertEqual("aap noot", V1HMACAuthenticator.to_canonicalize_header_value("aap\nnoot  "))
        self.assertEqual("aap noot", V1HMACAuthenticator.to_canonicalize_header_value(" aap\r\n  noot"))
    ...
    def test_to_data_to_sign(self):
        ...
        authenticator = V1HMACAuthenticator("apiKeyId", "secretApiKey")
    ...
    def test_create_authentication_signature_2(self):
        """Tests if the default authenticator creates the correct signature"""
        authenticator = V1HMACAuthenticator("apiKeyId", "6Kj5HT0MQKC6D8eb7W3lTg71kVKVDSt1")
        data_to_sign = "GET\n" \
                       "\n" \
                       "Fri, 06 Jun 2014 13:39:43 GMT\n" \
                       "/v1/9991/tokens/123456789\n"
