...
from worldline.connect.sdk.v1.platform_exception import PlatformException
...
class DefaultConnectionLoggerTest(unittest.TestCase):
    ...
    def test_logging_test_connection(self):
        ...
        with create_server_listening(handler) as address:  # start server to listen to request
            with create_client(address) as client:  # create client under test
                ...
                response = client.v1().merchant("1234").services().testconnection()
    ...
    def test_logging_convert_amount(self):
        ...
        with create_server_listening(handler) as address:  # start server to listen to request
            with create_client(address) as client:  # create client under test
                client.enable_logging(logger)
                response = client.v1().merchant("1234").services().convert_amount(query_params)
    ...
    def test_delete_token(self):
        ...
        with create_server_listening(handler) as address:  # start server to listen to request
            with create_client(address) as client:  # create client under test
                client.enable_logging(logger)
                client.v1().merchant("1234").tokens().delete("5678", None)
    ...
    def test_create_payment_unicode(self):
        ...
        with create_server_listening(handler) as address:  # start server to listen to request
            with create_client(address) as client:  # create client under test
                client.enable_logging(logger)
                response = client.v1().merchant("1234").payments().create(request)
    ...
    def test_create_payment_invalid_card_number(self):
        ...
        with create_server_listening(handler) as address:  # start server to listen to request
            with create_client(address) as client:  # create client under test
                client.enable_logging(logger)
                self.assertRaises(ValidationException, client.v1().merchant("1234").payments().create, request)
        ...
        with create_server_listening(handler) as address:  # start server to listen to request
            with create_client(address) as client:  # create client under test
                ...
                with self.assertRaises(DeclinedPaymentException) as exc:
                    client.v1().merchant("1234").payments().create(request)
    ...
    def test_logging_unknown_server_error(self):
        ...
        with create_server_listening(handler) as address:  # start server to listen to request
            with create_client(address) as client:  # create client under test
                client.enable_logging(logger)
                with self.assertRaises(PlatformException):
                    client.v1().merchant("1234").services().testconnection()
