...
class CommunicatorConfigurationTest(unittest.TestCase):
    ...
    def setUp(self):
        ...
        self.config.set('ConnectSDK', "connect.api.endpoint.host", "api.preprod.connect.worldline-solutions.com")
    ...
    def assertDefaults(self, communicator_config):
        ...
        self.assertEqual("https://api.preprod.connect.worldline-solutions.com", communicator_config.api_endpoint.geturl())
    ...
    def test_construct_from_properties_with_host_and_scheme(self):
        ...
        self.assertEqual("http://api.preprod.connect.worldline-solutions.com", communicator_config.api_endpoint.geturl())
    ...
    def test_construct_from_properties_with_host_and_port(self):
        ...
        self.assertEqual("https://api.preprod.connect.worldline-solutions.com:8443", communicator_config.api_endpoint.geturl())
    ...
    def test_construct_from_properties_with_host_scheme_port(self):
        ...
        self.assertEqual("http://api.preprod.connect.worldline-solutions.com:8080", communicator_config.api_endpoint.geturl())
    ...
    def test_construct_from_properties_with_metadata(self):
        ...
        """
        self.config.set("ConnectSDK", "connect.api.integrator", "Worldline.Integrator")
        self.config.set("ConnectSDK", "connect.api.shoppingCartExtension.creator", "Worldline.Creator")
        self.config.set("ConnectSDK", "connect.api.shoppingCartExtension.name", "Worldline.ShoppingCarts")
